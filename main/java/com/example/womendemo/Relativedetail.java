...
public class Relativedetail extends AppCompatActivity {
...
//    int ids[] = {R.id.number_1, R.id.email1};
//    String values[] = new String[et.length];
//
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.relative_detail);
        ...
        etmail_1 = (EditText) findViewById(R.id.email1);
        etmail_2 = (EditText) findViewById(R.id.email2);
        etmail_3 = (EditText) findViewById(R.id.email3);
        etmail_4 = (EditText) findViewById(R.id.email4);
        etmail_5 = (EditText) findViewById(R.id.email5);
...
//        }
    ...
    public void relative_user(View v) {
...
//        }
//        if (i == et.length) {
//            long cno = Long.parseLong(values[0]);
//            MyDatabase2 my = new MyDatabase2(this);
//            SQLiteDatabase database = my.getWritableDatabase();
//            String qry = "insert into relative_Detail values (" + cno + ",'" + values[1] + "')";
